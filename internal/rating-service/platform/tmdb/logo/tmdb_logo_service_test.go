...
import (
	...
	mocks "github.com/zepollabot/media-rating-overlay/internal/rating-service/platform/tmdb/logo/mocks"
)

type TMDBLogoServiceTestSuite struct {
	suite.Suite
	mockLogoCreator *mocks.LogoCreator
	logger          *zap.Logger
	config          *model.PosterConfig
	testConfigPath  string
	service         *TMDBLogoService
}

func (s *TMDBLogoServiceTestSuite) SetupTest() {
	s.mockLogoCreator = new(mocks.LogoCreator)
	s.logger = zap.NewNop() // Use Noop logger for tests

	s.testConfigPath = "path/to/tmdb/audience/normal.png"
	...
	s.service = NewTMDBLogoService(s.logger, s.config, s.mockLogoCreator)
}

func (s *TMDBLogoServiceTestSuite) TearDownTest() {
	s.mockLogoCreator.AssertExpectations(s.T())
}

func TestTMDBLogoServiceTestSuite(t *testing.T) {
	suite.Run(t, new(TMDBLogoServiceTestSuite))
}

func (s *TMDBLogoServiceTestSuite) TestNewTMDBLogoService() {
	// Arrange
	logger := zap.NewNop()
	config := &model.PosterConfig{}
	...
	// Act
	service := NewTMDBLogoService(logger, config, mockLogoCreator)
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_Success_SingleRating() {
	// Arrange
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_Success_MultipleRatings() {
	// Arrange
	ctx := context.Background()
	ratings := []model.Rating{
		{Rating: 7.8},
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_NoRatings() {
	// Arrange
	ctx := context.Background()
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_RatingIsZero() {
	// Arrange
	ctx := context.Background()
	ratings := []model.Rating{
		{Rating: 0.0},
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_CreateLogoError() {
	// Arrange
	ctx := context.Background()
	ratings := []model.Rating{
		{Rating: 7.8},
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_Success_MultipleRatings_OneZero() {
	// Arrange
	ctx := context.Background()
	ratings := []model.Rating{
		{Rating: 7.8},
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_Success_RatingRounded() {
	// Arrange
	ctx := context.Background()
	ratings := []model.Rating{
...
func (s *TMDBLogoServiceTestSuite) TestGetLogos_ContextCancelled() {
	// Arrange
